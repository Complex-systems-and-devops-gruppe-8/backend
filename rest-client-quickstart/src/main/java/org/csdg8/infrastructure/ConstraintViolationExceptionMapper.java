 ...
 * 
 * <p>
 * To use this functionality, annotate request class fields with {@link jakarta.validation.constraints.NotNull}, etc. 
 * and when these properties must hold (for example in a controller class) annotate the parameter with {@link jakarta.validation.Valid}.
 * In the case that the constraint-violations do not hold a {@link ConstraintViolationException} is thrown, caught here 
 * and a response is returned outlining all the fields which violated the requirements.
 * </p>
 * 
 * <pre>
 * //DTO request object
